...
const QStringList SettingsWindow::_languageNames{"", "Deutsch", "English", "Français", "Magyar", "Italiano", "日本語", "한국어", "Português Brasileiro", "Svenska", "中文"};
const QStringList SettingsWindow::_languageAbbreviations{"auto", "de", "en", "fr", "hu", "it", "ja", "ko", "pt_BR", "sv", "zh_CN"};
